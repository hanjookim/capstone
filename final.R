...
ran_twitts<-sample(twitts, 100000, replace=FALSE) 
ran_news<-sample(news, 100000, replace=FALSE) 
ran_blogs<-sample(blogs, 100000, replace=FALSE) 
...
#write csv 
write.csv(df_unigram, file="C:/My Documents/Company Work/LA County/Capstone/uni.csv") 
write.csv(df_bigram, file="C:/My Documents/Company Work/LA County/Capstone/bi.csv") 
write.csv(df_trigram, file="C:/My Documents/Company Work/LA County/Capstone/tri.csv") 
write.csv(df_quagram, file="C:/My Documents/Company Work/LA County/Capstone/qua.csv") 

#write Rdata 
save(df_unigram, file="C:/My Documents/Company Work/LA County/Capstone/uni.Rdata") 
save(df_bigram, file="C:/My Documents/Company Work/LA County/Capstone/bi.Rdata") 
save(df_trigram, file="C:/My Documents/Company Work/LA County/Capstone/tri.Rdata") 
save(df_quagram, file="C:/My Documents/Company Work/LA County/Capstone/qua.Rdata") 
